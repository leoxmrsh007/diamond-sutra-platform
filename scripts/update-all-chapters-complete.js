...
惠能安置母毕。即便辞违。不经三十余日。便至黄梅。礼拜五祖。祖问曰。汝何方人。欲求何物。惠能对曰。弟子是岭南新州百姓。远来礼师。惟求作佛。不求余物。

祖言。汝是岭南人。又是獦獠。若为堪作佛。惠能曰。人虽有南北。佛性本无南北。獦獠身与和尚不同。佛性有何差别。五祖更欲与语。且见徒众。总在左右。乃令随众作务。惠能曰。惠能启和尚。弟子自心常生智慧。不离自性。即是福田。未审和尚教作何务。祖云。这獦獠根性大利。汝更勿言。着槽厂去。
...
惠能曰。我亦要诵此。结来生缘。上人。我此踏碓。八个余月。未曾行到堂前。望上人引至偈前礼拜。童子引至偈前礼拜。惠能曰。惠能不识字。请上人为读。时有江州别驾。姓张。名日用。便高声读。惠能闻已。遂言。亦有一偈。望别驾为书。

别驾言。汝亦作偈。其事希有。

惠能向别驾言。欲学无上菩提。不可轻于初学。下下人有上上智。上上人有没意智。若轻人。即有无量无边罪。别驾言。汝但诵偈。吾为汝书。汝若得法。先须度吾。勿忘此言。
...
祖复曰。昔达摩大师。初来此土。人未之信。故传此衣。以为信体。代代相承。法则以心传心。皆令自悟自证。自古。佛佛惟传本体。师师密付本心。衣为争端。止汝勿传。若传此衣。命如悬丝。汝须速去。恐人害汝。

惠能启曰。向甚处去。祖云。逢怀则止。遇会则藏。惠能三更领得衣钵。云。能本是南中人。素不知此山路。如何出得江口。五祖言。汝不须忧。吾自送汝。

祖相送直至九江驿边。祖令上船。五祖把橹自摇。惠能言。请和尚坐。弟子合摇橹。祖云。合是吾渡汝。惠能言。迷时师度。悟了自度。度名虽一。用处不同。惠能生在边方。语音不正。蒙师传法。今已得悟。只合自性自度。祖云。如是如是。
...
善知识。小根之人。闻此顿教。犹如草木。根性小者。若被大雨。悉皆自倒。不能增长。小根之人。亦复如是。元有般若之智。与大智人更无差别。因何闻法不自开悟。缘邪见障重。烦恼根深。犹如大云。覆盖于日。不得风吹。日光不现。般若之智亦无大小。为一切众生自心迷悟不同。迷心外见。修行觅佛。未悟自性。即是小根。若开悟顿教。不能外修。但于自心常起正见。烦恼尘劳常不能染。即是见性。
...
师曰。有疑即问。吾当为说。韦公曰。弟子闻和尚所说。可不是达摩大师宗旨乎。师曰。是。公曰。弟子闻达摩初化梁武帝。帝问云。朕一生造寺度僧。布施设斋。有何功德。达摩言。实无功德。弟子未达此理。愿和尚为说。
...
凡愚不了自性。不识身中净土。愿东愿西。悟人在处一般。所以佛言。随所住处恒安乐。使君心地但无不善。西方去此不遥。若怀不善之心。念佛往生难到。今劝善知识。先除十恶。即行十万八千。后除八邪。乃过八千。

念念见性。常行平直。到如弹指。便睹弥陀。

使君但行十善。何须更愿往生。不断十恶之心。何佛即来迎请。若悟无生顿法。见西方只在刹那。不悟。念佛求生路遥。如何得达。惠能与诸人移西方于刹那间。目前便见。各愿见否。众皆顶礼云。若此处见。何须更愿往生。愿和尚慈悲。便现西方。普令得见。

师言。大众。世人自色身是城。眼耳鼻舌身是门。外有五门。内有意门。心是地。性是王。王居心地上。性在王在。性去王无。性在身心存。性去身心坏。佛向性中作。莫向身外求。自性迷即是众生。自性觉即是佛。慈悲即是观音。喜舍名为势至。能净即释迦。平直即弥陀。人我是须弥。欲即是海水。烦恼是波浪。毒害是恶龙。虚妄是鬼神。尘劳是鱼鳖。贪瞋是地狱。愚痴是畜生。

善知识。常行十善。天堂便至。除人我。须弥倒。去邪心。海水竭。烦恼无。波浪灭。毒害除。鱼龙绝。自心地上。觉性如来。放大光明。外照六门清净。能破六欲诸天。自性内照。三毒即除。地狱等罪。一时消灭。内外明彻。不异西方。不作此修。如何到彼。

大众闻说。了然见性。悉皆礼拜。俱叹善哉。唱言。普愿法界众生。闻者一时悟解。

师言。善知识。若欲修行。在家亦得。不由在寺。在家能行。如东方人心善。在寺不修。如西方人心恶。但心清净。即是自性西方。韦公又问。在家如何修行。愿为教授。
...
师示众云。善知识。一行三昧者。于一切处。行住坐卧。常行一直心是也。净名经云。直心是道场。直心是净土。泞心行谄曲。口但说直。口说一行三昧。不行直心。于一切法。勿有执着。迷人着法相。执一行三昧。直言常坐不动。妄不起心。即是一行三昧。作此解者。即同无情。却是障道因缘。
...
善知识。无者无何事。念者念何物。无者无二相。无诸尘劳之心。念者念真如本性。真如即是念之体。念即是真如之用。真如有性。所以起念。真如若无。眼耳鼻舌能念。真如有性。所以起念。真如若无。眼耳色声当时即坏。
...
善知识。已上是为无相忏悔。云何名忏。云何名悔。忏者。忏其前愆。从前所有恶业。愚迷憍诳嫉妒等罪。悉皆尽忏。永不复起。悔者。悔其后过。从今已后。所有恶业。愚迷憍诳嫉妒等罪。今已觉悟。悉皆永断。更不复作。是名为悔。故称忏悔。凡夫愚迷。只知忏其前愆。不知悔其后过。以不悔故。前愆不灭。后过又生。前愆既不灭。后过复生。何名忏悔。
...
凡夫不会。从日至夜。受三归戒。若言归依佛。佛在何处。若不见佛。凭何所归。

言却成妄。

今既自悟。各须归依自心三宝。内调心性。外敬他人。是自归依。

妙行品第五
师示众云。此门坐禅。元不着心。亦不着净。亦不是不动。若言着心。心原是妄。知心如幻。故无所著也。若言着净。人性本净。由妄念故。盖覆真如。但无妄想。性自清净。

若心着相。即生邪见。若心执空。即长无明。执空之人有谤经。直言不用文字。既云不用文字。人亦不合语言。只此语言。便是文字之相。又云直道不立文字。即此不立两字。亦是文字。

见人所说。便即谤他言着文字。汝等须知。自迷犹可。又谤佛经。不要谤经。罪障无数。

若着相于外。而作法求真。或广立道场。说有无之过患。如是之人。累劫不可见性。但听依法修行。

又莫百物不思。而于道性挂碍。若听说不修。令人反生邪念。

但依法修行。无住相法施。汝等若悟。依此说。依此用。依此行。依此作。即不失本宗。

若有人问汝义。问有将无对。问无将有对。问凡以圣对。问圣以凡对。二道相因。生中道义。如一问一对。余问一依此作。即不失理也。

设有人问。何名为暗。答云。明是因。暗是缘。明没即暗。以明显暗。以暗显明。来去相因。成中道义。余问悉皆如此。

汝等于后传法。依此转相教授。勿失宗旨。

机缘品第七
师自黄梅得法。回至韶州曹侯村。人无知者。有儒士刘志略。礼遇甚厚。志略有姑为尼。名无尽藏。常诵大涅槃经。师暂听。即知妙义。遂为解说。尼乃执卷问字。师曰。字即不识。义即请问。尼曰。字尚不识。焉能会义。

师曰。诸佛妙理。非关文字。尼惊异之。遍告里中耆德云。此是有道之士。宜请供养。有魏武侯玄孙曹叔良。及居民。竞来瞻礼。

时宝林古寺。自隋末兵火。已废。遂于故基重建梵宇。延师居之。俄成宝坊。

师住九月余日。又为恶党寻逐。师乃遁于前山。被其纵火焚草木。师隐身入石中得免。石今有师趺坐膝痕。及衣布之纹。因名避难石。

师忆五祖怀会止藏之嘱。遂行隐于二邑焉。

僧法海。韶州曲江人也。初参祖师。问曰。即心即佛。愿垂指谕。师曰。前念不生即心。后念不灭即佛。成一切相即心。离一切相即佛。
...
曰。念法华经已及三千部。师曰。汝若念至万部。得其经意。不以为胜。则与吾偕行。汝今负此事业。都不知过。
...
师曰。法达。法即甚达。汝心不达。经本无疑。汝心自疑。汝念此经。以何为宗。达曰。学人根性闇钝。从来但依文诵念。岂知宗趣。

师曰。吾不识文字。汝试取经诵一遍。吾当为汝解说。

法达即高声念经。至譬喻品。师曰止。此经元来以因缘出世为宗。纵说多种譬喻。亦无越于此。何者因缘。
...
彼既是佛。已具知见。何用更开。汝今当信。佛知见者。只汝自心。更无别佛。盖为一切众生。自蔽光明。贪爱尘境。外缘内扰。甘受驱驰。
...
达闻偈。不觉悲泣。言下大悟。而告师曰。法达从昔已来。实未曾转法华。乃被法华转。再启曰。经云。诸大声闻。乃至菩萨。皆尽思共度量。不能测佛智者。
...
况经文明向汝道。唯一佛乘。无有余乘。若二若三。乃至无数方便。种种因缘。譬喻言词。
...
若离本性。别说三身。即名有身无智。若悟三身无有自性。即名四智菩提。听吾偈曰。
...
何更问耶。若离三身。别谈四智。此名有智无身。即此有智。还成无智。复说偈曰。
...
如上。转识为智也。教中云。转前五识为成所作智。转第六识为妙观察智。转第七识为平等性智。转第八识为大圆镜智。
...
曰。智常到彼。凡经三月。未蒙示诲。为法切故。一夕独入丈室。请问如何是某甲本心本性。大通乃曰。

汝见虚空否。对曰。见。

彼曰。汝知虚空有相貌否。对曰。虚空无形。有何相貌。

彼曰。汝之本性。犹如虚空。了无一物可见。是名正见。无一物可知。是名真知。

无有青黄长短。但见本源清净觉体圆明。即名见性成佛。
...
一切时中。自性自如。常礼谢。执侍终师之世。

僧志道。广州南海人也。请益曰。学人自出家。览涅槃经。十载有余。未明大意。
...
// 按行分割成段落
function parseTextByChapters(text) {
  const chapters = [
    { num: 1, name: '行由品', start: '时大师至宝林', end: '三更受法。人尽不知。便传顿教及衣钵。云。汝为第六代祖。善自护念。广度有情。流布将来。无令断绝。听吾偈曰。' },
    { num: 2, name: '般若品', start: '有情来下种。因地果还生。无情即无种。无性亦无生。', end: '此宗本无诤。诤即失道意。执逆诤法门。自性入生死。' },
    { num: 3, name: '疑问品', start: '师说偈已。端坐至三更。忽谓门人曰。吾行矣。奄然迁化。', end: '亦无功用。妄念不起。荡荡心无着。' },
    { num: 4, name: '定慧品', start: '师示众云。善知识。我此法门。以定慧为本。大众勿迷。言定慧别。定慧一体。不是二。', end: '灯是光之体。光是灯之用。名虽有二。体本同一。此定慧法。亦复如是。' },
    { num: 5, name: '妙行品', start: '师示众云。善知识。此门坐禅。元不着心。亦不着净。亦不是不动。', end: '亦名真性。即是名真如。若见一切法。心不染着。是为真定。' },
    { num: 6, name: '忏悔品', start: '时大师见广韶洎四方士庶。骈集山中听法。于是升座告众曰。来诸善知识。', end: '无上大涅槃。圆明常寂照。凡愚谓之死。外道执为断。' },
    { num: 7, name: '机缘品', start: '师自黄梅得法。回至韶州曹侯村。人无知者。', end: '行昌禀旨。宵遁。后投僧出家。具戒精进。' },
    { num: 8, name: '顿渐品', start: '时祖师居曹溪宝林。神秀大师在荆南玉泉寺。于时两宗盛化。', end: '善知识。吾今为汝说。谛信永无迷。莫学驰求者。终日说菩提。' },
    { num: 9, name: '宣诏品', start: '神龙元年上元日。则天中宗皇帝诏云。朕请安秀二师。宫中供养。', end: '赐师旧居为国恩寺。' },
    { num: 10, name: '付嘱品', start: '师一日唤门人。法海。志诚。法达。神会。智常。智通。志道。法珍。法如等。', end: '普利群生者。' },
  ];

  return chapters.map(chapter => {
    start: text.indexOf(chapter.start),
    end: text.indexOf(chapter.end);
  });
}

// 按章节提取内容
function extractChapterContent(text, chapterNum) {
  const chapters = parseTextByChapters(text);
  const chapter = chapters[chapterNum - 1];
  if (!chapter) {
    return '';
  }
  const chapterText = text.slice(chapter.start, chapter.end + chapter.end.length); // + chapter.end.length 包含结束标记
...
async function updateAllChaptersComplete() {
  console.log('🔍 更新所有章节的完整内容...\n');

  let totalSections = 0;
  let totalChars = 0;

  for (let i = 1; i <= 10; i++) {
    const chapterText = extractChapterContent(FULL_PLATFORM_SUTRA_TEXT, i);
    console.log(`📝 处理第 ${i} 品：共 ${chapterText.split('。').length} 个句子`);
    ...
    if (chapter1) {
      ...
      const sectionTexts = extractChapterContent(FULL_PLATFORM_SUTRA_TEXT, 1).split('。');
      const newSections = sectionTexts
      ...
      totalChars += newSections.reduce((sum, s) => sum + s.content.length, 0);

      await prisma.section.createMany({ data: newSections });
      console.log(`   ✅ 第1品已更新（${newSections.length} 个段落，${newSections.reduce((sum, s) => sum + s.content.length, 0)} 字符）`);
    }
    ...
    if (chapter2) {
      const sectionTexts = extractChapterContent(FULL_PLATFORM_SUTRA_TEXT, 2).split('。');
      const newSections = sectionTexts
        .filter(s => s.trim().length > 2)
        .map((content, index) => ({
          sectionNum: index + 1,
      ...
      await prisma.section.createMany({ data: newSections });
      console.log(`   ✅ 第2品已更新（${newSections.length} 个段落）`);
    }
    ...
    if (chapter3) {
      const sectionTexts = extractChapterContent(FULL_PLATFORM_SUTRA_TEXT, 3).split('。');
      const newSections = sectionTexts
        .filter(s => s.trim().length > 2)
        .map((content, index) => ({
          sectionNum: index + 1,
      ...
      await prisma.section.createMany({ data: newSections });
      console.log(`   ✅ 第3品已更新（${newSections.length} 个段落）`);
    }
    ...
    if (chapter4) {
      const sectionTexts = extractChapterContent(FULL_PLATFORM_SUTRA_TEXT, 4).split('。');
      const newSections = sectionTexts
        .filter(s => s.trim().length > 2)
        .map((content, index) => ({
          sectionNum: index + 1,
      ...
      await prisma.section.createMany({ data: newSections });
      console.log(`   ✅ 第4品已更新（${newSections.length} 个段落）`);
    }
    ...
    if (chapter5) {
      const sectionTexts = extractChapterContent(FULL_PLATFORM_SUTRA_TEXT, 5).split('。');
      const newSections = sectionTexts
        .filter(s => s.trim().length > 2)
        .map((content, index) => ({
          sectionNum: index + 1,
      ...
      await prisma.section.createMany({ data: newSections });
      console.log(`   ✅ 第5品已更新（${newSections.length} 个段落）`);
    }
    ...
    if (chapter6) {
      const sectionTexts = extractChapterContent(FULL_PLATFORM_SUTRA_TEXT, 6).split('。');
      const newSections = sectionTexts
        .filter(s => s.trim().length > 2)
        .map((content, index) => ({
          sectionNum: index + 1,
      ...
      await prisma.section.createMany({ data: newSections });
      console.log(`   ✅ 第6品已更新（${newSections.length} 个段落）`);
    }
    ...
    if (chapter7) {
      const sectionTexts = extractChapterContent(FULL_PLATFORM_SUTRA_TEXT, 7).split('。');
      const newSections = sectionTexts
        .filter(s => s.trim().length > 2)
        .map((content, index) => ({
          sectionNum: index + 1,
      ...
      await prisma.section.createMany({ data: newSections });
      console.log(`   ✅ 第7品已更新（${newSections.length} 个段落）`);
    }
    ...
    if (chapter8) {
      const sectionTexts = extractChapterContent(FULL_PLATFORM_SUTRA_TEXT, 8).split('。');
      const newSections = sectionTexts
        .filter(s => s.trim().length > 2)
        .map((content, index) => ({
          sectionNum: index + 1,
      ...
      await prisma.section.createMany({ data: newSections });
      console.log(`   ✅ 第8品已更新（${newSections.length} 个段落）`);
    }
    ...
    if (chapter9) {
      const sectionTexts = extractChapterContent(FULL_PLATFORM_SUTRA_TEXT, 9).split('。');
      const newSections = sectionTexts
        .filter(s => s.trim().length > 2)
        .map((content, index) => ({
          sectionNum: index + 1,
      ...
      await prisma.section.createMany({ data: newSections });
      console.log(`   ✅ 第9品已更新（${newSections.length} 个段落）`);
    }
    ...
    if (chapter10) {
      const sectionTexts = extractChapterContent(FULL_PLATFORM_SUTRA_TEXT, 10).split('。');
      const newSections = sectionTexts
        .filter(s => s.trim().length > 2)
        .map((content, index) => ({
          sectionNum: index + 1,
      ...
      await prisma.section.createMany({ data: newSections });
      console.log(`   ✅ 第10品已更新（${newSections.length} 个段落）`);
    }
    ...
    if (sutra) {
      const openingGatha = FULL_PLATFORM_SUTRA_TEXT.split('\n').slice(0, 10).join('\n');
      const sutraDescription = `《六祖大师法宝坛经》，简称《坛经》，是中国禅宗第六代祖师惠能的言行录。门人法海编集，后学德清勘校。全名《六祖大师法宝坛经》。\n${openingGatha}`;

      await prisma.sutra.update({
        where: { id: sutra.id },
        data: { description: sutraDescription },
      });
      console.log(`   ✅ 经书描述已更新（${sutraDescription.length} 字符）`);
    }

    console.log('\n✅ 所有章节完整内容更新完成！');
    console.log(`   总段落数: ${totalSections}`);
